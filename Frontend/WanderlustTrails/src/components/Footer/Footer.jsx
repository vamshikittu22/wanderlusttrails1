...
export default function Footer() {
    ...
    useEffect(() => {
      setTitle(document.title); // Get the title from the document
    }, []);
  return (
      <footer className="bg-blur border-y py-2 mt-5">
          <div className="mx-auto w-full max-w-screen-xl p-4 py-2 lg:py-6">
              <div className="md:flex md:justify-between">
                  <div className="mb-6 md:mb-0">
                      <Link to="/" className="container flex items-center hover:text-orange-700">
                            <img
                              src={logo}
                              className="mr-8 h-16 "
                              alt="Logo"
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:gap-6 sm:grid-cols-3 ">
                      <div>
                          <h2 className="mb-3 text-sm font-semibold text-gray-300 uppercase">Resources</h2>
                      ...
                      <div>
                          <h2 className="mb-3 text-sm font-semibold text-gray-300 uppercase">Follow us</h2>
                          <ul className="text-gray-500 font-medium">
                              <li className="mb-4">
                                  <a
                                      href="https://github.com/vamshikittu22"
                      ...
                      <div>
                          <h2 className="mb-3 text-sm font-semibold text-gray-300 uppercase">Legal</h2>
                          <ul className="text-gray-500 font-medium">
                              <li className="mb-4">
                                  <Link to="#" className="hover:underline hover:text-orange-700">
                                      Privacy Policy
